...
def verify_pipeline():
    ...
    if os.path.exists("weights/cdr_former.pth"): os.remove("weights/cdr_former.pth")
    ...
    if not os.path.exists("weights/cdr_former.pth"):
    ...
    try:
        benchmark_models("weights/cdr_former.pth")
    except Exception as e:
