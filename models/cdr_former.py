...
class CDRFormer(nn.Module):
    """
    CDRFormer: A Data-Centric Graph Transformer for Quantum Error Mitigation.
    
    Building on the ML-QEM paradigm, CDRFormer focuses on efficient training data
    generation via Clifford Data Regression (CDR) + Pauli Twirling.
